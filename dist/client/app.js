...
const translations = {
  zh: {
    subtitle: '会话分叉、工作区恢复与 DAG 分支探索', branchLabel: '分支：', sessionLabel: '会话：', noSessions: '暂无已保存会话',
